...
export function Onboarding({children}: {children: React.ReactNode}) {
  ...
  if (shouldShowOnboarding) {
    return <div className={styles.onboardingPage}>
    ...
    <>
      <div className={styles.hero}>
        <div className={styles.heroTitles}>
          ...
          <h2 className={styles.subtitle}>Optimize infrastructure spend, simplify debugging, and enhance application performance</h2>
      ...
      <div className={styles.onboardingRow}>
        ...
        <div className={styles.onboardingPanel}>
          ...
          <p className={styles.onboardingPanelDescription}>
            Maintain high speed and efficiency and improve application performance. In a competitive digital world, decreasing latency translates to increasing revenue.
          </p>
        </div>
        <div className={styles.onboardingPanel}>
          ...
          <p className={styles.onboardingPanelDescription}>
            Cut down the mean time to resolution (MTTR) by correlating continuous profiling data with metrics, logs, and traces to quickly identify the root cause of any issue.
          </p>
        </div>
      </div>
      ...
      <div className={styles.onboardingRow}>
        <div className={styles.onboardingPanel}>
          ...
          <p className={styles.onboardingPanelDescription}>
            Use <StyledLink href="https://grafana.com/docs/pyroscope/next/configure-client/grafana-agent/">Grafana Agent</StyledLink> or <StyledLink href="https://grafana.com/docs/pyroscope/next/configure-client/language-sdks/">Pyroscope SDKs</StyledLink> to push profiles from your applications to Grafana Cloud.
          </p>
        </div>
        <div className={styles.onboardingPanel}>
          ...
          <p className={styles.onboardingPanelDescription}>
            Go to <StyledLink href={url}>Grafana Cloud Stack settings</StyledLink> to find your Grafana Cloud Credentials.
          </p>
        </div>
        <div className={styles.onboardingPanel}>
      ...
      <div className={styles.onboardingRow}>
        <p className={styles.onboardingParagraph}>
          Usage of Grafana Cloud Profiles is subject to <StyledLink href="https://grafana.com/pricing/">Grafana Cloud Pricing</StyledLink> for Profiles.
          <br></br>
          For additional information, read the announcement&nbsp;<StyledLink
            href="https://grafana.com/blog/2023/08/09/grafana-cloud-profiles-for-continuous-profiling/"
          >blog post
          </StyledLink>.
        </p>
      </div>
