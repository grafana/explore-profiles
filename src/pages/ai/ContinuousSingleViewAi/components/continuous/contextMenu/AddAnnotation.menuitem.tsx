...
import { Popover, PopoverBody, PopoverFooter, PopoverHeader } from '@pyroscope/ui/Popover';
...
function AddAnnotation(props: AddAnnotationProps) {
  const { container, popoverAnchorPoint, onCreateAnnotation, timestamp, timezone } = props;
